...
import { BookOpen, BookOpenIcon, LayoutDashboardIcon, SparklesIcon } from "lucide-react";
Link;
  ...
  return (
    <nav className="bg-base-100/80 backdrop-blur-md border-b border-primary/20 sticky top-0 z-50 shadow-lg">
      <div className="max-w-7xl mx-auto p-4 flex items-center justify-between">
        ...
        <Link
          to="/"
          className="grou[ flex items-center gap-3 hover:scale-105 transition-transform duration-200"
        >
